 ...
 */ const pressEnterTwiceToExit = (editor)=>{
   ...
   */ const nodeEntry = Editor$1.above(editor, {
        match: (node)=>!Editor$1.isEditor(node) && ![
                'link',
                'text'
            ].includes(node.type)
    });
...
const insertLink = (editor, { url })=>{
    if (editor.selection) {
        ...
        const linkNodes = Array.from(Editor$1.nodes(editor, {
            at: editor.selection,
 ...
 */ const handleEnterKeyOnList = (editor)=>{
    ...
    if (isListEmpty) {
        ...
        const currentNode = Editor$1.above(editor, {
...
const BlocksDropdown = ()=>{
    ...
    const handleSelect = (optionKey)=>{
        ...
        if (!editor.selection && !editorIsEmpty) {
            ...
            Transforms.select(editor, Editor$1.start(editor, [
                0,
                0
            ]));
        }
   ...
   */ const preventSelectFocus = (e)=>e.preventDefault();
    ...
    React.useEffect(()=>{
        if (editor.selection) {
            ...
            const anchorBlockKey = getKeys(blocks).find((blockKey)=>!Editor$1.isEditor(selectedNode) && blocks[blockKey].matchNode(selectedNode));
...
const ListButton = ({ block, format, location = 'toolbar' })=>{
    ...
    const isListActive = ()=>{
        ...
        if (currentListEntry) {
            const [currentList] = currentListEntry;
            if (!Editor$1.isEditor(currentList) && isListNode(currentList) && currentList.format === format) return true;
        }
        return false;
    };
    /**
...
const LinkButton = ({ disabled, location = 'toolbar' })=>{
    ...
    const isLinkActive = ()=>{
        ...
        const [match] = Array.from(Editor$1.nodes(editor, {
    ...
    if (isExpandedMode) {
        return /*#__PURE__*/ jsx(Portal, {
            ...
            children: /*#__PURE__*/ jsx(FocusTrap, {
                onEscape: onCollapse,
                children: /*#__PURE__*/ jsx(ExpandWrapper$1, {
                    position: "fixed",
                    top: 0,
                    left: 0,
                    right: 0,
...
const withLinks = (editor)=>{
    ...
    editor.insertText = (text)=>{
        ...
        if (editor.selection && Range.isCollapsed(editor.selection) && text === ' ') {
            const linksInSelection = Array.from(Editor$1.nodes(editor, {
                at: editor.selection,
                match: (node)=>!Editor$1.isEditor(node) && node.type === 'link'
            }));
        ...
        children: [
            ...
            /*#__PURE__*/ jsx(Slate, {
                ...
                children: /*#__PURE__*/ jsx(BlocksEditorProvider, {
                    ...
                    isExpandedMode: isExpandedMode,
                    children: /*#__PURE__*/ jsxs(EditorLayout$1, {
                        error: error,
                        disabled: disabled,
    ...
    return /*#__PURE__*/ jsxs(ComponentContainer, {
        ...
        children: [
            ...
            /*#__PURE__*/ jsx(StyledBox, {
                ref: composedBoxRefs,
                hasRadius: true,
                children: isDragging ? /*#__PURE__*/ jsx(Preview$1, {}) : /*#__PURE__*/ jsx(Accordion.Root, {
                            ...
                            /*#__PURE__*/ jsx(Accordion.Content, {
                                children: /*#__PURE__*/ jsx(AccordionContentRadius, {
                                    ...
                                    children: /*#__PURE__*/ jsx(Box, {
                                        ...
                                        paddingTop: 6,
                                        paddingBottom: 6,
                                        children: /*#__PURE__*/ jsx(Grid$1.Root, {
                                            gap: 4,
                                            children: components[componentUid]?.layout?.map((row, rowInd)=>/*#__PURE__*/ jsx(Grid$1.Item, {
                                                    col: 12,
                                                    s: 12,
                                                    xs: 12,
                                                    direction: "column",
...
const DynamicZone = ({ attribute, disabled: disabledProp, hint, label, labelAction, name, required = false, children })=>{
    ...
    const handleAddComponent = (uid, position)=>{
        ...
        const transformations = pipe$1(transformDocument(schema, components), (data)=>({
                ...data,
                __component: uid
            }));
...
const Editor = /*#__PURE__*/ React.forwardRef(({ disabled, editorRef, error, isPreviewMode, isExpandMode, name, onChange, placeholder, textareaRef, value }, forwardedRef)=>{
    ...
    return /*#__PURE__*/ jsxs(EditorAndPreviewWrapper, {
        children: [
            /*#__PURE__*/ jsx(EditorStylesContainer, {
            ...
            isPreviewMode && /*#__PURE__*/ jsx(PreviewWysiwyg, {
                data: value
            })
        ]
    });
                                ...
                                /*#__PURE__*/ jsxs(Flex, {
                                    ...
                                    children: [
                                        /*#__PURE__*/ jsx(Flex, {
                                            ...
                                            shrink: 0,
                                            width: "100%",
                                            children: /*#__PURE__*/ jsxs(ExpandButton$1, {
                                                onClick: onCollapse,
                                                variant: "tertiary",
                                                size: "M",
                                                children: [
    ...
    return /*#__PURE__*/ jsx(Flex, {
        ...
        children: layout.map((panel, index)=>{
            if (panel.some((row)=>row.some((field)=>field.type === 'dynamiczone'))) {
                ...
                return /*#__PURE__*/ jsx(Grid$1.Root, {
                    gap: 4,
                    children: /*#__PURE__*/ jsx(Grid$1.Item, {
                        col: 12,
                        s: 12,
                        xs: 12,
                        direction: "column",
