...
import { createContext, useContext, useState, Fragment, useRef, useEffect, memo, useMemo, Suspense, lazy } from 'react';
...
import { p as pluginId, n as nameToSlug, a as actions, g as getRelationType, M as MAX_COMPONENT_DEPTH, c as createComponentUid, b as createUid, i as initialState, d as initialState$1, m as makeUnique, u as useAutoReloadOverlayBlocker, e as actions$1, r as retrieveComponentsFromSchema, P as PERMISSIONS, A as AutoReloadOverlayBlockerProvider } from './index-BhX2euW0.mjs';
...
const FormModalEndActions = ({ categoryName, deleteCategory, deleteComponent, deleteContentType, isAttributeModal, isCustomFieldModal, isComponentAttribute, isComponentToDzModal, isContentTypeModal, isCreatingComponent, isCreatingComponentAttribute, isCreatingComponentInDz, isCreatingComponentWhileAddingAField, isCreatingContentType, isCreatingDz, isComponentModal, isDzAttribute, isEditingAttribute, isEditingCategory, isInFirstComponentStep, onSubmitAddComponentAttribute, onSubmitAddComponentToDz, onSubmitCreateContentType, onSubmitCreateComponent, onSubmitCreateDz, onSubmitEditAttribute, onSubmitEditCategory, onSubmitEditComponent, onSubmitEditContentType, onSubmitEditCustomFieldAttribute, onSubmitEditDz, onClickFinish })=>{
    ...
    if (isContentTypeModal) {
        return /*#__PURE__*/ jsxs(Flex, {
            gap: 2,
            children: [
                !isCreatingContentType && /*#__PURE__*/ jsxs(Fragment$1, {
                    children: [
                        /*#__PURE__*/ jsx(Button, {
                            type: "button",
                            variant: "danger",
    ...
    if (isComponentModal) {
        return /*#__PURE__*/ jsxs(Flex, {
            gap: 2,
            children: [
                !isCreatingComponent && /*#__PURE__*/ jsxs(Fragment$1, {
                    children: [
                        /*#__PURE__*/ jsx(Button, {
                            type: "button",
                            variant: "danger",
            ...
            /*#__PURE__*/ jsx(Menu.Content, {
                ...
                children: allowedContentTypesForRelation.map(({ uid, title, restrictRelationsTo, plugin })=>/*#__PURE__*/ jsxs(Menu.Item, {
                        ...
                        children: [
                            title,
                            " ",
                            plugin && /*#__PURE__*/ jsxs(Fragment$1, {
                                children: [
                                    "(from: ",
                                    plugin,
                                    ")"
...
const ListView = /*#__PURE__*/ lazy(()=>import('./ListView-CDnrvVrV.mjs'));
const App = ()=>{
    const { formatMessage } = useIntl();
        ...
        children: [
            ...
            /*#__PURE__*/ jsx(AutoReloadOverlayBlockerProvider, {
                children: /*#__PURE__*/ jsx(FormModalNavigationProvider, {
                    children: /*#__PURE__*/ jsx(DataManagerProvider$1, {
...
export { AttributeIcon as A, COMPONENT_ICONS as C, useFormModalNavigation as a, getTrad as g, index as i, useDataManager as u };
//# sourceMappingURL=index-Cr5tfW7U.mjs.map
