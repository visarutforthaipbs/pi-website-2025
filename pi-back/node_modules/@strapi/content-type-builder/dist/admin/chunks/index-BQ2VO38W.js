...
var index$1 = require('./index-BZeN5KRn.js');
...
const AttributeOption = ({ type = 'text' })=>{
    ...
    return /*#__PURE__*/ jsxRuntime.jsx(OptionBoxWrapper, {
        padding: 4,
        tag: "button",
        hasRadius: true,
        type: "button",
        ...
        children: /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
            children: [
                /*#__PURE__*/ jsxRuntime.jsx(AttributeIcon, {
                    type: type
                }),
            ...
            children: attributes.map((attributeRow, index)=>{
                ...
                /*#__PURE__*/ jsxRuntime.jsx(designSystem.Grid.Root, {
                    ...
                    children: attributeRow.map((attribute)=>/*#__PURE__*/ jsxRuntime.jsx(designSystem.Grid.Item, {
                            ...
                            direction: "column",
                            alignItems: "stretch",
                            children: /*#__PURE__*/ jsxRuntime.jsx(AttributeOption, {
                                type: attribute
                            })
                        }, attribute))
                }, index));
            ...
            children: [
                /*#__PURE__*/ jsxRuntime.jsx(designSystem.Grid.Root, {
                    ...
                    children: sortedCustomFields.map(([uid, customField])=>/*#__PURE__*/ jsxRuntime.jsx(designSystem.Grid.Item, {
                            ...
                            direction: "column",
                            alignItems: "stretch",
                            children: /*#__PURE__*/ jsxRuntime.jsx(CustomFieldOption, {
                                customFieldUid: uid,
        ...
        children: /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Tabs.Root, {
            ...
            children: [
                ...
                /*#__PURE__*/ jsxRuntime.jsx(designSystem.Tabs.Content, {
                    value: "default",
                    children: /*#__PURE__*/ jsxRuntime.jsx(AttributeList, {
                        attributes: attributes
                    })
                }),
                /*#__PURE__*/ jsxRuntime.jsx(designSystem.Tabs.Content, {
                    value: "custom",
                    children: /*#__PURE__*/ jsxRuntime.jsx(CustomFieldsList, {})
                })
            ]
        })
    });
...
const BooleanRadioGroup = ({ onChange, name, intlLabel, ...rest })=>{
    ...
    return /*#__PURE__*/ jsxRuntime.jsx(CustomRadioGroup, {
        ...rest,
        name: name,
        onChange: handleChange,
        intlLabel: intlLabel
...
const FormModalHeader = ({ actionType = null, attributeName, attributeType, categoryName, contentTypeKind, dynamicZoneTarget, forTarget, modalType = null, targetUid, customFieldUid = null, showBackLink = false })=>{
    const { formatMessage } = reactIntl.useIntl();
    ...
    if (isCreatingMainSchema) {
        ...
        return /*#__PURE__*/ jsxRuntime.jsx(designSystem.Modal.Header, {
            children: /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
                children: [
                    /*#__PURE__*/ jsxRuntime.jsx(designSystem.Box, {
                        children: /*#__PURE__*/ jsxRuntime.jsx(AttributeIcon, {
                            type: icon
                        })
                    }),
                    /*#__PURE__*/ jsxRuntime.jsx(designSystem.Box, {
    ...
    headers = [
        {
            ...
            info: {
                ...
                name: schema?.schema.displayName
            }
        }
    ];
...
const PluralName = ({ description, error, intlLabel, modifiedData, name, onChange, value })=>{
    ...
    React.useEffect(()=>{
        if (displayName) {
            const value = index$1.nameToSlug(displayName);
            try {
...
const GenericInput = ({ autoComplete, customInputs, description, disabled, intlLabel, labelAction, error, name, onChange, options = [], placeholder, required, step, type, value: defaultValue, isNullable, attribute, ...rest })=>{
    const { formatMessage } = reactIntl.useIntl();
...
const RelationTargetPicker = ({ oneThatIsCreatingARelationWithAnother, target })=>{
    ...
    const handleSelect = ({ uid, plugin, title, restrictRelationsTo })=>()=>{
            ...
            dispatch(index$1.actions.onChangeRelationTarget({
                target: {
                    value: uid,
        ...
        children: [
            /*#__PURE__*/ jsxRuntime.jsx(designSystem.Flex, {
                ...
                children: isMain ? /*#__PURE__*/ jsxRuntime.jsx(designSystem.Typography, {
                    ...
                    textColor: "neutral800",
                    children: header
                }) : /*#__PURE__*/ jsxRuntime.jsx(RelationTargetPicker, {
                    target: target,
            ...
            /*#__PURE__*/ jsxRuntime.jsx(designSystem.Box, {
                padding: 4,
                children: /*#__PURE__*/ jsxRuntime.jsx(MemoizedGenericInput, {
                    disabled: disabled,
                    error: error?.id || null,
                    intlLabel: {
...
const RelationNaturePicker = ({ naturePickerType, oneThatIsCreatingARelationWithAnother, relationType, target })=>{
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
        ...
        children: [
                        ...
                        children: /*#__PURE__*/ jsxRuntime.jsx(designSystem.Flex, {
                            ...
                            children: relationsType.map((relation)=>{
                                ...
                                return /*#__PURE__*/ jsxRuntime.jsx(IconWrapper, {
                                    ...
                                    onClick: ()=>{
                                        if (isEnabled) {
                                            dispatch(index$1.actions.onChangeRelationType({
                                                target: {
                                                    oneThatIsCreatingARelationWithAnother,
                                                    value: relation
                                                }
            ...
            /*#__PURE__*/ jsxRuntime.jsxs(InfosWrapper, {
                justifyContent: "center",
                children: [
...
const Relation = ({ formErrors, mainBoxHeader, modifiedData, naturePickerType, onChange })=>{
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
        ...
        children: [
            /*#__PURE__*/ jsxRuntime.jsx(RelationFormBox, {
                isMain: true,
            ...
            /*#__PURE__*/ jsxRuntime.jsx(RelationNaturePicker, {
    ...
    React.useEffect(()=>{
        if (displayName) {
            onChangeRef.current({
                target: {
                    name,
                    value: index$1.nameToSlug(displayName)
                }
            });
        } else {
            onChangeRef.current({
...
const FormModal = ()=>{
    ...
    React__namespace.useEffect(()=>{
        if (isOpen) {
            ...
            if (modalType === 'editCategory' && actionType === 'edit') {
                dispatch(index$1.actions.setDataToEdit({
                    data: {
                        name: categoryName
                    }
                }));
            ...
            if (modalType === 'addComponentToDynamicZone' && actionType === 'edit') {
                ...
                dispatch(index$1.actions.setDynamicZoneDataSchema({
                    attributeToEdit
                }));
            }
            ...
            if (attributeType) {
                ...
                if (modalType === 'customField') {
                    if (actionType === 'edit') {
                        dispatch(index$1.actions.setCustomFieldDataSchema({
                            isEditing: true,
                    ...
                    dispatch(index$1.actions.setAttributeDataSchema({
                        attributeType,
            ...
            dispatch(index$1.actions.resetProps());
        }
    ...
    const handleChange = React__namespace.useCallback(({ target: { name, value, type, ...rest } })=>{
        ...
        dispatch(index$1.actions.setErrors({
            errors: clonedErrors
        }));
        dispatch(index$1.actions.onChange({
            keys: name.split('.'),
            value: val
        }));
    }, [
        ...
        try {
            ...
            if (isCreatingContentType) {
                ...
                if (isCreating) {
                    ...
                    navigate({
                        pathname: `/plugins/${index$1.pluginId}/content-types/${uid}`
                    });
            ...
            // Add/edit a field to a created component (the end modal is not step 2)
                ...
                if (isDynamicZoneAttribute) {
                    ...
                    if (isCreating) {
                        ...
                        dispatch(index$1.actions.resetPropsAndSetTheFormForAddingACompoToADz());
                        setActiveTab('basic');
                ...
                if (isInFirstComponentStep) {
                    ...
                    dispatch(index$1.actions.resetPropsAndSetFormForAddingAnExistingCompo({}));
            ...
            // We need to prevent the component from being created if the user closes the modal at step 2 without any submission
                ...
                if (isInFirstComponentStep) {
                    ...
                    dispatch(index$1.actions.resetPropsAndSaveCurrentData({}));
                    onNavigateToCreateComponentStep2();
                ...
                if (isInFirstComponentStep) {
                    if (isCreatingComponentFromAView) {
                        ...
                        const componentUid = index$1.createComponentUid(modifiedData.componentToCreate.displayName, category);
                        // Create the component first and add it to the components data
                        createSchema(// Component data
                        rest, // Type will always be component
                        // It will dispatch the CREATE_COMPONENT_SCHEMA action
    ...
    return /*#__PURE__*/ jsxRuntime.jsx(designSystem.Modal.Root, {
        ...
        children: /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Modal.Content, {
            children: [
                /*#__PURE__*/ jsxRuntime.jsx(FormModalHeader, {
                ...
                isPickingAttribute && /*#__PURE__*/ jsxRuntime.jsx(AttributeOptions, {
                    ...
                    children: [
                            ...
                            children: /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Tabs.Root, {
                                ...
                                children: [
                                    /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
                                        justifyContent: "space-between",
                                        children: [
                                            /*#__PURE__*/ jsxRuntime.jsx(FormModalSubHeader, {
                                                actionType: actionType,
                                                forTarget: forTarget,
                                                kind: kind,
                                                step: step,
                                    ...
                                    /*#__PURE__*/ jsxRuntime.jsx(designSystem.Tabs.Content, {
                                        ...
                                        children: /*#__PURE__*/ jsxRuntime.jsx(designSystem.Flex, {
                                            ...
                                            alignItems: "stretch",
                                            gap: 6,
                                            children: /*#__PURE__*/ jsxRuntime.jsx(TabForm, {
                                                form: baseForm,
                        ...
                        /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Modal.Footer, {
                            children: [
                                ...
                                /*#__PURE__*/ jsxRuntime.jsx(FormModalEndActions, {
...
const getCreatedAndModifiedComponents = (allComponents, initialComponents)=>{
    const componentUIDsToReturn = Object.keys(allComponents).filter((compoUid)=>{
        ...
        const hasComponentBeenCreated = get(currentCompo, [
            'isTemporary'
        ], false);
...
const formatComponent = (component, mainDataUID)=>{
    const formattedAttributes = formatAttributes(get(component, 'schema.attributes', []), mainDataUID);
    ...
    const formattedComponent = Object.assign({}, compoUID, {
        category: component.category
    }, // Omit the attributes since we want to format them
    omit(component.schema, 'attributes'), // Add the formatted attributes
    {
...
const sortContentType = (types)=>sortBy(Object.keys(types).map((uid)=>({
...
const DataManagerProvider = ({ children })=>{
    const dispatch = reactRedux.useDispatch();
    // refactor
    const { components, contentTypes, isLoading, initialData, modifiedData, reservedNames } = reactRedux.useSelector(makeSelectDataManagerProvider());
    const { toggleNotification } = strapiAdmin.useNotification();
    ...
    const componentMatch = reactRouterDom.useMatch(`/plugins/${index$1.pluginId}/component-categories/:categoryUid/:componentUid`);
    ...
    getDataRef.current = async ()=>{
        try {
            ...
            dispatch(index$1.actions$1.init({
    ...
    React.useEffect(()=>{
        ...
        return ()=>{
            ...
            dispatch(index$1.actions$1.reloadPlugin());
        };
    // eslint-disable-next-line react-hooks/exhaustive-deps
    }, []);
    React.useEffect(()=>{
    ...
    const addAttribute = (attributeToSet, forTarget, targetUid, isEditing = false, initialAttribute, shouldAddComponentToData = false)=>{
        if (isEditing) {
            ...
            dispatch(index$1.actions$1.editAttribute(payload));
        } else {
            const payload = {
                attributeToSet,
                forTarget,
            ...
            dispatch(index$1.actions$1.addAttribute(payload));
        }
    };
    const addCustomFieldAttribute = ({ attributeToSet, forTarget, targetUid })=>{
        dispatch(index$1.actions$1.addCustomFieldAttribute({
            attributeToSet,
            forTarget,
            targetUid
        }));
    ...
    const editCustomFieldAttribute = ({ attributeToSet, forTarget, targetUid, initialAttribute })=>{
        dispatch(index$1.actions$1.editCustomFieldAttribute({
            attributeToSet,
            forTarget,
            targetUid,
            initialAttribute
    ...
    const addCreatedComponentToDynamicZone = (dynamicZoneTarget, componentsToAdd)=>{
        dispatch(index$1.actions$1.addCreatedComponentToDynamicZone({
            dynamicZoneTarget,
            componentsToAdd
        }));
    };
    const createSchema = (data, schemaType, uid, componentCategory, shouldAddComponentToData = false)=>{
        if (schemaType === 'contentType') {
            ...
            dispatch(index$1.actions$1.createSchema(payload));
        } else {
            const payload = {
                data,
                uid,
            ...
            dispatch(index$1.actions$1.createComponentSchema(payload));
        }
    };
    const changeDynamicZoneComponents = (dynamicZoneTarget, newComponents)=>{
        dispatch(index$1.actions$1.changeDynamicZoneComponents({
            dynamicZoneTarget,
            newComponents
        }));
    };
    const removeAttribute = (mainDataKey, attributeToRemoveName, componentUid = '')=>{
        if (mainDataKey === 'components') {
            dispatch(index$1.actions$1.removeFieldFromDisplayedComponent({
            ...
            dispatch(index$1.actions$1.removeField({
                mainDataKey,
                attributeToRemoveName
            }));
        }
        ...
        try {
            ...
            if (userConfirm) {
                if (isTemporary) {
                    ...
                    dispatch(index$1.actions$1.deleteNotSavedType());
                    return;
                }
                lockAppWithAutoreload?.();
                await del(requestURL);
    ...
    const removeComponentFromDynamicZone = (dzName, componentToRemoveIndex)=>{
        dispatch(index$1.actions$1.removeComponentFromDynamicZone({
            dzName,
    ...
    const setModifiedData = ()=>{
        ...
        const retrievedComponents = index$1.retrieveComponentsFromSchema(schemaToSet.schema.attributes, components);
        ...
        dispatch(index$1.actions$1.setModifiedData({
    ...
    if (shouldRedirect) {
        return /*#__PURE__*/ jsxRuntime.jsx(reactRouterDom.Navigate, {
            to: `/plugins/${index$1.pluginId}/content-types/${redirectEndpoint}`
        });
    }
    ...
    const updateSchema = (data, schemaType, componentUID)=>{
        dispatch(index$1.actions$1.updateSchema({
            data,
            schemaType,
            uid: componentUID
        }));
    };
    return /*#__PURE__*/ jsxRuntime.jsxs(DataManagerContext.Provider, {
        value: {
            addAttribute,
...
const FormModalNavigationProvider = ({ children })=>{
    ...
    return /*#__PURE__*/ jsxRuntime.jsx(FormModalNavigationContext.Provider, {
        value: {
            ...state,
            onClickSelectField,
            onClickSelectCustomField,
...
const ListView = /*#__PURE__*/ React.lazy(()=>Promise.resolve().then(function () { return require('./ListView-CQwvSbZH.js'); }));
const App = ()=>{
    const { formatMessage } = reactIntl.useIntl();
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs(strapiAdmin.Page.Protect, {
        permissions: index$1.PERMISSIONS.main,
        children: [
            /*#__PURE__*/ jsxRuntime.jsx(strapiAdmin.Page.Title, {
                children: title
            }),
            /*#__PURE__*/ jsxRuntime.jsx(index$1.AutoReloadOverlayBlockerProvider, {
                children: /*#__PURE__*/ jsxRuntime.jsx(FormModalNavigationProvider, {
                    children: /*#__PURE__*/ jsxRuntime.jsx(DataManagerProvider$1, {
                        children: /*#__PURE__*/ jsxRuntime.jsx(strapiAdmin.Layouts.Root, {
                            sideNav: /*#__PURE__*/ jsxRuntime.jsx(ContentTypeBuilderNav, {}),
...
//# sourceMappingURL=index-BQ2VO38W.js.map
