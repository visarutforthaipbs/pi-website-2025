...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    case './translations/en.json': return import('./en-B2EeDoOz.mjs');
     ...
     */ app.createHook('ContentReleases/pages/ReleaseDetails/add-locale-in-releases');
        if (window.strapi.features.isEnabled('cms-content-releases')) {
            app.addMenuLink({
                ...
                Component: ()=>import('./App-CuOosufQ.mjs').then((mod)=>({
                            default: mod.App
                        })),
            ...
            app.addSettingsLink('global', {
                ...
                permissions: [],
                async Component () {
                    const { ProtectedReleasesSettingsPage } = await import('./ReleasesSettingsPage-BzdLEfxa.mjs');
                    return {
            ...
            app.addSettingsLink('global', {
                ...
                permissions: [],
                async Component () {
                    const { PurchaseContentReleases } = await import('./PurchaseContentReleases-S1ccDSwp.mjs');
                    return {
...
//# sourceMappingURL=index-CmAFGQWf.mjs.map
