        ...
        children: [
            /*#__PURE__*/ jsxs(RelativeBox, {
                ...
                children: [
                    ...
                    /*#__PURE__*/ jsxs(Wrapper$1, {
                        children: [
                            isLoading && /*#__PURE__*/ jsx(UploadProgressWrapper$1, {
                            ...
                            isLoadingUpload && /*#__PURE__*/ jsx(UploadProgressWrapper$1, {
                                children: /*#__PURE__*/ jsx(UploadProgress, {
                                    error: uploadError,
...
const AudioAssetCard = ({ name, url, size = 'M', selected = false, ...restProps })=>{
    return /*#__PURE__*/ jsx(AssetCardBase, {
        ...
        ...restProps,
        variant: "Audio",
        children: /*#__PURE__*/ jsx(CardAsset$2, {
            size: size,
            children: /*#__PURE__*/ jsx(Flex, {
                alignItems: "center",
                children: /*#__PURE__*/ jsx(AudioPreviewWrapper$1, {
                    size: size,
...
const VideoAssetCard = ({ name, url, mime, size = 'M', selected = false, ...props })=>{
    ...
    return /*#__PURE__*/ jsxs(AssetCardBase, {
        ...
        variant: "Video",
        children: [
            /*#__PURE__*/ jsx(CardAsset$2, {
                size: size,
                children: /*#__PURE__*/ jsx(VideoPreviewWrapper$2, {
                    size: size,
...
const PreviewCell = ({ type, content })=>{
    ...
    if (mime?.includes(AssetType.Video)) {
        return /*#__PURE__*/ jsx(VideoPreviewWrapper$1, {
            children: /*#__PURE__*/ jsx(VideoPreview, {
...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    case './translations/ca.json': return import('./ca-Bi4qskZD.mjs');
    case './translations/de.json': return import('./de-BlbX8Dl_.mjs');
    case './translations/dk.json': return import('./dk-C2ydE6A7.mjs');
    case './translations/en.json': return import('./en-Bw_Cb2IV.mjs');
    case './translations/es.json': return import('./es-CiEgbw0k.mjs');
    case './translations/fr.json': return import('./fr-CwRt2FJu.mjs');
    case './translations/he.json': return import('./he-DdpYNQdt.mjs');
    case './translations/it.json': return import('./it-Be4kgSNB.mjs');
    case './translations/ja.json': return import('./ja-U1NhT0bU.mjs');
    case './translations/ko.json': return import('./ko-BciqXefq.mjs');
    case './translations/ms.json': return import('./ms-D-8McNeg.mjs');
    case './translations/pl.json': return import('./pl-DdUYocl5.mjs');
    case './translations/pt-BR.json': return import('./pt-BR-Demjoq41.mjs');
    case './translations/pt.json': return import('./pt-D8is2LpS.mjs');
    case './translations/ru.json': return import('./ru-CGgHRTey.mjs');
    case './translations/sk.json': return import('./sk-xtSwaPXq.mjs');
    case './translations/th.json': return import('./th-BOpLVfmg.mjs');
    case './translations/tr.json': return import('./tr-BmAPh-f1.mjs');
    case './translations/uk.json': return import('./uk-CMvuEdG-.mjs');
    case './translations/zh-Hans.json': return import('./zh-Hans-B1GabBRx.mjs');
    case './translations/zh.json': return import('./zh-BIl0qgBy.mjs');
...
const admin = {
    register (app) {
        app.addMenuLink({
            ...
            Component: ()=>import('./App-CMTq4gKS.mjs').then((mod)=>({
                        default: mod.Upload
                    })),
            position: 4
        });
        app.addSettingsLink('global', {
            ...
            async Component () {
                const { ProtectedSettingsPage } = await import('./SettingsPage-B5LRvKK8.mjs');
                return {
...
export { AssetGridList as A, Breadcrumbs as B, pageSizes as C, sortOptions as D, EmptyAssets as E, FilterPopover as F, admin as G, PERMISSIONS as P, SelectTree as S, TableList as T, UploadAssetDialog as U, getFolderURL as a, useBulkRemove as b, useFolderStructure as c, displayedFilters as d, FilterList as e, useMediaLibraryPermissions as f, getTrad as g, usePersistentState as h, useAssets as i, useFolders as j, containsAssetFilter as k, useFolder as l, useSelectionState as m, normalizeAPIError as n, SortPicker as o, pluginId as p, FolderGridList as q, FolderCard as r, FolderCardBody as s, FolderCardBodyAction as t, useFolderCard as u, viewOptions as v, EditFolderDialog as w, EditAssetDialog as x, localStorageKeys as y, useConfig as z };
//# sourceMappingURL=index-OqeI_4qD.mjs.map
