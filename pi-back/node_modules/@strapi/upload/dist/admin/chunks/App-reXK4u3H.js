...
var index = require('./index-CA81ILUU.js');
require('byte-size');
require('date-fns');
var qs = require('qs');
...
// TODO: find a better naming convention for the file that was an index file before
const ConfigureTheView = /*#__PURE__*/ React__namespace.lazy(async ()=>Promise.resolve().then(function () { return require('./ConfigureTheView-D3Fnih4J.js'); }).then((mod)=>({
...
//# sourceMappingURL=App-reXK4u3H.js.map
