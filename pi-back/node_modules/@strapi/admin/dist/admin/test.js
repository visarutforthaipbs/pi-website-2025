...
var Theme = require('./chunks/Theme-CFGbtvHi.js');
var admin = require('./chunks/admin-udBiOv2o.js');
var msw = require('msw');
...
const server = node.setupServer(...[
    /**
     * TRACKING
     */ msw.rest.post('https://analytics.strapi.io/api/v2/track', (req, res, ctx)=>{
     ...
     * ADMIN ROLES
     *
     */ msw.rest.get('/admin/roles', (req, res, ctx)=>res(ctx.json({
            data: [
                {
                    id: 1,
                    code: 'strapi-editor',
    ...
    msw.rest.get('/admin/roles/1', (req, res, ctx)=>res(ctx.json({
            data: {
                id: 1,
                code: 'strapi-editor',
                params: {
    ...
    msw.rest.get('/admin/roles/:id/permissions', (req, res, ctx)=>{
        return res(ctx.json({
            data: [
                {
                    id: 1,
     ...
     * ADMIN USERS
     *
     */ msw.rest.get('/admin/users', (req, res, ctx)=>{
        return res(ctx.json({
            data: {
                results: [
                    {
    ...
    msw.rest.get('/admin/users/1', (req, res, ctx)=>res(ctx.json({
            data: {
                id: 1,
                firstname: 'John',
                lastname: 'Doe',
    ...
    msw.rest.get('/admin/users/me/permissions', (req, res, ctx)=>res(ctx.json({
            data: []
        }))),
    /**
     *
     * ADMIN PROVIDERS
     *
     */ msw.rest.get('/admin/providers/isSSOLocked', (req, res, ctx)=>{
        return res(ctx.json({
            data: {
                isSSOLocked: false
            }
    ...
    msw.rest.put('/admin/providers/options', (req, res, ctx)=>res(ctx.json({
            data: {
                autoRegister: false,
                defaultRole: '1',
                ssoLockedRoles: [
    ...
    msw.rest.get('/admin/providers/options', (req, res, ctx)=>res(ctx.json({
            data: {
                autoRegister: false,
                defaultRole: '1',
                ssoLockedRoles: [
     ...
     * ADMIN MISC
     *
     */ msw.rest.get('/admin/init', (req, res, ctx)=>{
        return res(ctx.json({
            data: {}
        }));
    }),
    msw.rest.get('/admin/information', (req, res, ctx)=>res(ctx.json({
            autoReload: true,
    ...
    msw.rest.get('/admin/license-limit-information', (req, res, ctx)=>{
        return res(ctx.json({
            data: {
                attribute: 1,
                features: [
    ...
    msw.rest.get('/admin/project-settings', (req, res, ctx)=>{
        return res(ctx.json({
            menuLogo: {
                ext: '.svg',
                height: 256,
    ...
    msw.rest.post('/admin/project-settings', (req, res, ctx)=>{
        return res(ctx.json({
            menuLogo: {
                ext: '.svg',
                height: 256,
    ...
    msw.rest.get('/admin/transfer/tokens', (req, res, ctx)=>{
        return res(ctx.json({
            data: [
                {
                    id: 1,
    ...
    msw.rest.get('/admin/transfer/tokens/:id', (req, res, ctx)=>{
        return res(ctx.json({
            data: {
                id: 1,
                name: 'My super token',
    ...
    msw.rest.get('/admin/registration-info', async (req, res, ctx)=>{
    ...
    msw.rest.post('/admin/renew-token', (req, res, ctx)=>{
        return res(ctx.json({
            data: {
    ...
    msw.rest.post('/admin/webhooks/batch-delete', async (req, res, ctx)=>{
        const { ids } = await req.json();
        return res(ctx.json({
            data: mockData.webhooks.filter((webhook)=>!ids.includes(webhook.id))
        }));
    }),
    msw.rest.put('/admin/webhooks/:id', async (req, res, ctx)=>{
        const { id } = req.params;
     ...
     * CONTENT_MANAGER
     *
     */ msw.rest.get('/content-manager/content-types', (req, res, ctx)=>res(ctx.json({
            data: [
                {
    ...
    msw.rest.get('/content-manager/components', (req, res, ctx)=>res(ctx.json({
            data: [
                {
                    uid: 'basic.relation',
                    isDisplayed: true,
     ...
     * MARKETPLACE
     *
     */ msw.rest.get('https://market-api.strapi.io/providers', (req, res, ctx)=>{
        const { collections = [], search = '' } = qs__namespace.parse(req.url.searchParams.toString());
        ...
        if (madeByStrapi && verified) {
            responseData = {
                data: [
                    ...providerResponses[madeByStrapi].data,
                    ...providerResponses[verified].data
                ],
    ...
    msw.rest.get('https://market-api.strapi.io/plugins', (req, res, ctx)=>{
        const { collections = [], categories = [], search = '' } = qs__namespace.parse(req.url.searchParams.toString());
        const [madeByStrapi, verified] = collections;
        ...
        if (categories.length && collections.length) {
            responseData = {
                data: [
                    ...pluginResponses[collections[0]].data,
                    ...pluginResponses[categories[0]].data
                ],
            ...
            responseData = {
                data: [
                    ...pluginResponses[madeByStrapi].data,
                    ...pluginResponses[verified].data
                ],
                meta: pluginResponses.plugins.meta
            };
            ...
            responseData = {
                data: [
                    ...pluginResponses[customFields].data,
                    ...pluginResponses[monitoring].data
                ],
                meta: pluginResponses.plugins.meta
            };
        } else if (collections.length) {
     ...
     * NPS SURVEY
     *
     */ msw.rest.post('https://analytics.strapi.io/submit-nps', (req, res, ctx)=>{
        return res(ctx.status(200));
    }),
    /**
     * CONTENT-API (API TOKENS)
     */ msw.rest.get('/admin/content-api/permissions', (req, res, ctx)=>{
        return res(ctx.json({
            data: {
                'api::address': {
                    controllers: {
    ...
    msw.rest.get('/admin/content-api/routes', (req, res, ctx)=>{
        return res(ctx.json({
            data: {
                'api::address': [
                    {
    ...
    /**
     * API TOKENS
     */ msw.rest.get('/admin/api-tokens', (req, res, ctx)=>{
        return res(ctx.json({
            data: [
                {
                    id: '1',
    ...
    msw.rest.get('/admin/audit-logs/:id', (req, res, ctx)=>{
        return res(ctx.json({
            id: 1,
            action: 'admin.logout',
            date: '2023-10-31T15:56:54.873Z',
     ...
     *
     */ msw.rest.get('/use-fetch-client-test', (req, res, ctx)=>{
        return res(ctx.json({
            data: {
                results: [
                    {
    ...
    msw.rest.get('/test-fetch-client', (req, res, ctx)=>{
        return res(ctx.status(200));
    })
]);
...
const Providers = ({ children, initialEntries, storeConfig, permissions = [] })=>{
    ...
    const router = reactRouterDom.createMemoryRouter([
        {
            path: '/*',
            element: /*#__PURE__*/ jsxRuntime.jsx(Theme.StrapiAppProvider, {
                components: {},
                rbac: new Theme.RBAC(),
                customFields: {
                    customFields: {},
                                    ...
                                    children: /*#__PURE__*/ jsxRuntime.jsx(Theme.Theme, {
                                        ...
                                        children: /*#__PURE__*/ jsxRuntime.jsx(Theme.NotificationsProvider, {
                                            children: /*#__PURE__*/ jsxRuntime.jsx(Theme.GuidedTourProvider, {
                                                children: /*#__PURE__*/ jsxRuntime.jsx(Theme.ConfigurationContextProvider, {
                                                    ...
                                                    children: /*#__PURE__*/ jsxRuntime.jsx(Theme.AppInfoProvider, {
                                                        autoReload: true,
                                                        useYarn: true,
                                                        dependencies: {
