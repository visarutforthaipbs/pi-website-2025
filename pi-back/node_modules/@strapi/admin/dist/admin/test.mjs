...
import { r as getStoredToken, t as reducer, S as StrapiAppProvider, R as RBAC, A as AuthProvider, L as LanguageProvider, T as Theme, N as NotificationsProvider, G as GuidedTourProvider, C as ConfigurationContextProvider, v as AppInfoProvider } from './chunks/Theme-CDaBfQ-7.mjs';
import { a as adminApi } from './chunks/admin-BBS7sDVu.mjs';
...
const server = setupServer(...[
    ...
    rest.get('https://market-api.strapi.io/plugins', (req, res, ctx)=>{
        const { collections = [], categories = [], search = '' } = qs.parse(req.url.searchParams.toString());
        const [madeByStrapi, verified] = collections;
