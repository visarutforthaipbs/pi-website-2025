...
var Table = require('./Table-BHi0q5It.js');
 ...
 * -----------------------------------------------------------------------------------------------*/ const ListView = ()=>{
    ...
    const { isLoading: isLoadingRBAC, allowedActions: { canCreate, canDelete, canUpdate, canRead } } = Theme.useRBAC(permissions);
 ...
 * -----------------------------------------------------------------------------------------------*/ const ProtectedListView = ()=>{
    const permissions = Theme.useTypedSelector((state)=>state.admin_app.permissions.settings?.['transfer-tokens'].main);
...
//# sourceMappingURL=ListView-Bys8EN-y.js.map
