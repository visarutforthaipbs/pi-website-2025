 ...
 * -----------------------------------------------------------------------------------------------*/ const ListPage = ()=>{
    ...
    const { isLoading: isRBACLoading, allowedActions: { canCreate, canUpdate, canDelete } } = Theme.useRBAC(permissions);
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs(index.Layouts.Root, {
        children: [
            ...
            /*#__PURE__*/ jsxRuntime.jsxs(Theme.Page.Main, {
                "aria-busy": isLoading,
                children: [
                    ...
                    webhooksToDeleteLength > 0 && canDelete && /*#__PURE__*/ jsxRuntime.jsx(index.Layouts.Action, {
 ...
 * -----------------------------------------------------------------------------------------------*/ const ProtectedListPage = ()=>{
    const permissions = Theme.useTypedSelector((state)=>state.admin_app.permissions.settings?.webhooks.main);
...
//# sourceMappingURL=ListPage-LqcmQd_Q.js.map
