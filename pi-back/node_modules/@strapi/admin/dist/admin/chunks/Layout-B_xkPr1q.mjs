...
import { p as SETTINGS_LINKS_CE, b as Layouts } from './index-BUGouNML.mjs';
import { u as useAuth, p as useAppInfo, q as useStrapiApp, c as useTracking, P as Page } from './Theme-CDaBfQ-7.mjs';
...
const useSettingsMenu = ()=>{
   ...
   */ const ceLinks = React.useMemo(()=>SETTINGS_LINKS_CE(), []);
    const { admin: adminLinks, global: globalLinks } = useEnterprise(ceLinks, async ()=>(await import('./index-BUGouNML.mjs').then(function (n) { return n.O; })).SETTINGS_LINKS_EE(), {
...
export { Layout };
//# sourceMappingURL=Layout-B_xkPr1q.mjs.map
