 ...
 * -----------------------------------------------------------------------------------------------*/ const ProfilePage = ()=>{
    ...
    const { _unstableFormatValidationErrors: formatValidationErrors, _unstableFormatAPIError: formatApiError } = Theme.useAPIErrorHandler();
    ...
    const { isLoading, data: dataSSO, error } = Theme.useIsSSOLockedQuery(undefined, {
    ...
    const handleSubmit = async (body, { setErrors })=>{
        ...
        if ('data' in res) {
            dispatch(Theme.setAppTheme(currentTheme));
                ...
                children: ({ isSubmitting, modified })=>/*#__PURE__*/ jsxRuntime.jsxs(jsxRuntime.Fragment, {
                        children: [
                            ...
                            /*#__PURE__*/ jsxRuntime.jsx(designSystem.Box, {
                                paddingBottom: 10,
                                children: /*#__PURE__*/ jsxRuntime.jsx(index.Layouts.Content, {
    ...
    return /*#__PURE__*/ jsxRuntime.jsx(designSystem.Box, {
        ...
        children: /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
            ...
            children: [
                ...
                ].map((row, index$1)=>/*#__PURE__*/ jsxRuntime.jsx(designSystem.Grid.Root, {
                        gap: 5,
...
//# sourceMappingURL=ProfilePage-C8zWtYzY.js.map
