...
var useAdminRoles = require('./useAdminRoles-DwDqOIvp.js');
...
const ListPage = ()=>{
    ...
    const { isLoading: isLoadingForPermissions, allowedActions: { canCreate, canDelete, canRead, canUpdate } } = Theme.useRBAC(permissions.settings?.roles);
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs(Theme.Page.Main, {
        children: [
            ...
            canRead && /*#__PURE__*/ jsxRuntime.jsx(index.Layouts.Action, {
                startActions: /*#__PURE__*/ jsxRuntime.jsx(index.SearchInput, {
                    label: formatMessage({
            ...
            canRead && /*#__PURE__*/ jsxRuntime.jsx(index.Layouts.Content, {
                children: /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Table, {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ jsxRuntime.jsx(designSystem.Tbody, {
                            children: roles?.map((role, index)=>/*#__PURE__*/ jsxRuntime.jsx(RoleRow, {
                                    cursor: "pointer",
                                    id: role.id,
                                    name: role.name,
...
//# sourceMappingURL=ListPage-gKsEm3Px.js.map
