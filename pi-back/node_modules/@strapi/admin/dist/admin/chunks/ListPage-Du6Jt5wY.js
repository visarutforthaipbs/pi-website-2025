...
var index = require('./index-D7OmC33R.js');
...
var SelectRoles = require('./SelectRoles-Clx1_4zB.js');
...
require('./useAdminRoles-DwDqOIvp.js');
...
const ModalForm = ({ onToggle })=>{
    ...
    const roleLayout = useEnterprise.useEnterprise(ROLE_LAYOUT, async ()=>(await Promise.resolve().then(function () { return require('./ModalForm-Br-NALJ0.js'); })).ROLE_LAYOUT, {
    ...
    const initialValues = useEnterprise.useEnterprise(FORM_INITIAL_VALUES, async ()=>(await Promise.resolve().then(function () { return require('./ModalForm-Br-NALJ0.js'); })).FORM_INITIAL_VALUES, {
    ...
    const MagicLink = useEnterprise.useEnterprise(SelectRoles.MagicLinkCE, async ()=>(await Promise.resolve().then(function () { return require('./MagicLinkEE-a-AbOB4s.js'); })).MagicLinkEE);
    ...
    return /*#__PURE__*/ jsxRuntime.jsx(designSystem.Modal.Root, {
        ...
        children: /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Modal.Content, {
            children: [
                ...
                /*#__PURE__*/ jsxRuntime.jsx(index.Form, {
                                                                ...
                                                                children: FORM_LAYOUT.map((row)=>{
                                                                    return row.map(({ size, ...field })=>{
                                                                        return /*#__PURE__*/ jsxRuntime.jsx(designSystem.Grid.Item, {
                                                                            ...
                                                                            direction: "column",
                                                                            alignItems: "stretch",
                                                                            children: /*#__PURE__*/ jsxRuntime.jsx(index.MemoizedInputRenderer, {
                                                                                ...field,
                                                                                disabled: isDisabled,
 ...
 * -----------------------------------------------------------------------------------------------*/ const ListPageCE = ()=>{
    ...
    const { allowedActions: { canCreate, canDelete, canRead } } = Theme.useRBAC(permissions.settings?.users);
    ...
    const { data, isError, isLoading } = index.useAdminUsers(qs__namespace.parse(search, {
        ignoreQueryPrefix: true
    }));
    const { pagination, users: users$1 = [] } = data ?? {};
    const CreateAction = useEnterprise.useEnterprise(CreateActionCE, async ()=>(await Promise.resolve().then(function () { return require('./CreateActionEE-CSZxFkrZ.js'); })).CreateActionEE);
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs(Theme.Page.Main, {
        ...
        children: [
            ...
            /*#__PURE__*/ jsxRuntime.jsx(index.Layouts.Action, {
                startActions: /*#__PURE__*/ jsxRuntime.jsxs(jsxRuntime.Fragment, {
                    children: [
                        /*#__PURE__*/ jsxRuntime.jsx(index.SearchInput, {
                            label: formatMessage({
                        ...
                        /*#__PURE__*/ jsxRuntime.jsxs(index.Filters.Root, {
                            options: FILTERS,
                            children: [
            ...
            /*#__PURE__*/ jsxRuntime.jsxs(index.Layouts.Content, {
                children: [
                    /*#__PURE__*/ jsxRuntime.jsxs(index.Table.Root, {
                        rows: users$1,
                        headers: headers,
                        children: [
                            /*#__PURE__*/ jsxRuntime.jsx(index.Table.ActionBar, {}),
                            /*#__PURE__*/ jsxRuntime.jsxs(index.Table.Content, {
                                children: [
                                    /*#__PURE__*/ jsxRuntime.jsxs(index.Table.Head, {
                                        children: [
                                            canDelete ? /*#__PURE__*/ jsxRuntime.jsx(index.Table.HeaderCheckboxCell, {}) : null,
                                            headers.map((header)=>/*#__PURE__*/ jsxRuntime.jsx(index.Table.HeaderCell, {
                                                    ...header
                                                }, header.name))
                                        ]
                                    }),
                                    ...
                                    /*#__PURE__*/ jsxRuntime.jsx(index.Table.Body, {
                                        children: users$1.map((user)=>/*#__PURE__*/ jsxRuntime.jsxs(index.Table.Row, {
                                                onClick: handleRowClick(user.id),
                                                cursor: canRead ? 'pointer' : 'default',
                                                children: [
                                                    canDelete ? /*#__PURE__*/ jsxRuntime.jsx(index.Table.CheckboxCell, {
                                                        id: user.id
                                                    }) : null,
                                                    headers.map(({ cellFormatter, name, ...rest })=>{
                                                        return /*#__PURE__*/ jsxRuntime.jsx(index.Table.Cell, {
                                                    ...
                                                    canRead || canDelete ? /*#__PURE__*/ jsxRuntime.jsx(index.Table.Cell, {
                    ...
                    /*#__PURE__*/ jsxRuntime.jsxs(index.Pagination.Root, {
                        ...pagination,
                        children: [
            ...
            isModalOpened && /*#__PURE__*/ jsxRuntime.jsx(ModalForm, {
                onToggle: handleToggle
            }),
            /*#__PURE__*/ jsxRuntime.jsx(designSystem.Dialog.Root, {
                open: showDeleteConfirmation,
                onOpenChange: setShowDeleteConfirmation,
                children: /*#__PURE__*/ jsxRuntime.jsx(index.ConfirmDialog, {
...
const ListPage = ()=>{
    const UsersListPage = useEnterprise.useEnterprise(ListPageCE, async ()=>// eslint-disable-next-line import/no-cycle
        (await Promise.resolve().then(function () { return require('./ListPage-YW-UVjk3.js'); })).UserListPageEE);
    // block rendering until the EE component is fully loaded
    if (!UsersListPage) {
        return null;
    }
...
//# sourceMappingURL=ListPage-Du6Jt5wY.js.map
