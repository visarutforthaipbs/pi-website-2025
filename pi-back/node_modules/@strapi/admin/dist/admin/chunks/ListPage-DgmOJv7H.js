...
const useAuditLogsData = ({ canReadAuditLogs, canReadUsers })=>{
    ...
    const { data, error, isError: isUsersError, isLoading: isLoadingUsers } = index.useAdminUsers({}, {
        skip: !canReadUsers,
...
const ListPage = ()=>{
    ...
    const { allowedActions: { canRead: canReadAuditLogs, canReadUsers }, isLoading: isLoadingRBAC } = Theme.useRBAC({
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs(Theme.Page.Main, {
        ...
        children: [
            ...
            /*#__PURE__*/ jsxRuntime.jsx(index.Layouts.Action, {
                startActions: /*#__PURE__*/ jsxRuntime.jsxs(index.Filters.Root, {
            ...
            /*#__PURE__*/ jsxRuntime.jsxs(index.Layouts.Content, {
                children: [
                    /*#__PURE__*/ jsxRuntime.jsx(index.Table.Root, {
                        rows: results,
                        headers: headers,
                        isLoading: isLoading,
                        children: /*#__PURE__*/ jsxRuntime.jsxs(index.Table.Content, {
                            children: [
                                /*#__PURE__*/ jsxRuntime.jsx(index.Table.Head, {
                                    children: headers.map((header)=>/*#__PURE__*/ jsxRuntime.jsx(index.Table.HeaderCell, {
                                            ...header
                                        }, header.name))
                                }),
                                ...
                                /*#__PURE__*/ jsxRuntime.jsx(index.Table.Body, {
                                    children: results.map((log)=>/*#__PURE__*/ jsxRuntime.jsxs(index.Table.Row, {
                                            onClick: ()=>setQuery({
                                                    id: log.id
                                                }),
                                            children: [
                                                ...
                                                /*#__PURE__*/ jsxRuntime.jsx(index.Table.Cell, {
            ...
            query?.id && /*#__PURE__*/ jsxRuntime.jsx(Modal, {
...
const ProtectedListPage = ()=>{
    const permissions = Theme.useTypedSelector((state)=>state.admin_app.permissions.settings?.auditLogs?.main);
...
//# sourceMappingURL=ListPage-DgmOJv7H.js.map
