...
var validation = require('./validation-ECrFbJ6K.js');
 ...
 * -----------------------------------------------------------------------------------------------*/ const EditPage = ()=>{
    ...
    const { isLoading: isLoadingRBAC, allowedActions: { canUpdate } } = Theme.useRBAC({
        read: permissions.settings?.users.read ?? [],
        update: permissions.settings?.users.update ?? []
    });
    const [updateUser] = index.useUpdateUserMutation();
    const { data, error, isLoading: isLoadingAdminUsers } = index.useAdminUsers({
        id
    }, {
...
//# sourceMappingURL=EditPage-ibh8EtSv.js.map
