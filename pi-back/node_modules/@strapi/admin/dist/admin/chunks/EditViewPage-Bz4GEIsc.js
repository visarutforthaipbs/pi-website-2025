...
var TokenTypeSelect = require('./TokenTypeSelect-EY1WftKo.js');
...
require('./transferTokens-oEFM8kkT.js');
require('date-fns');
                ...
                /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Grid.Root, {
                    ...
                    children: [
                        /*#__PURE__*/ jsxRuntime.jsx(designSystem.Grid.Item, {
                            ...
                            direction: "column",
                            alignItems: "stretch",
                            children: /*#__PURE__*/ jsxRuntime.jsx(TokenTypeSelect.TokenName, {
                                error: errors['name'],
                                value: values['name'],
                        ...
                        /*#__PURE__*/ jsxRuntime.jsx(designSystem.Grid.Item, {
                            ...
                            direction: "column",
                            alignItems: "stretch",
                            children: /*#__PURE__*/ jsxRuntime.jsx(TokenTypeSelect.TokenDescription, {
                        ...
                        /*#__PURE__*/ jsxRuntime.jsx(designSystem.Grid.Item, {
                            ...
                            direction: "column",
                            alignItems: "stretch",
                            children: /*#__PURE__*/ jsxRuntime.jsx(TokenTypeSelect.LifeSpanInput, {
    ...
    return /*#__PURE__*/ jsxRuntime.jsx(designSystem.Grid.Item, {
        ...
        children: selectedAction ? /*#__PURE__*/ jsxRuntime.jsx(designSystem.Flex, {
            ...
            children: actionSection && actionSection in routes && routes[actionSection].map((route)=>{
                return route.config.auth?.scope?.includes(selectedAction) || route.handler === selectedAction ? /*#__PURE__*/ jsxRuntime.jsx(BoundRoute, {
                    route: route
                }, route.handler) : null;
            })
        }) : /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
...
const ContentTypesSection = ({ section = null, ...props })=>{
    return /*#__PURE__*/ jsxRuntime.jsx(designSystem.Box, {
        children: /*#__PURE__*/ jsxRuntime.jsx(designSystem.Accordion.Root, {
            size: "M",
            children: section && section.map((api, index)=>/*#__PURE__*/ jsxRuntime.jsx(CollapsableContentType, {
                    label: api.label,
        ...
        children: [
            /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Grid.Item, {
                ...
                children: [
                    ...
                    data?.permissions && /*#__PURE__*/ jsxRuntime.jsx(ContentTypesSection, {
...
const schema = yup__namespace.object().shape({
    ...
    type: yup__namespace.string().oneOf([
        ...
        'full-access',
        'custom'
    ]).required(index.errorsTrads.required.id),
 ...
 */ const EditView = ()=>{
    ...
    const setCurrentStep = Theme.useGuidedTour('EditView', (state)=>state.setCurrentStep);
    const { allowedActions: { canCreate, canUpdate, canRegenerate } } = Theme.useRBAC(permissions.settings?.['api-tokens']);
    ...
    const { _unstableFormatAPIError: formatAPIError, _unstableFormatValidationErrors: formatValidtionErrors } = Theme.useAPIErrorHandler();
   ...
   */ React__namespace.useEffect(()=>{
    ...
    return /*#__PURE__*/ jsxRuntime.jsx(ApiTokenPermissionsProvider, {
        value: providerValue,
        children: /*#__PURE__*/ jsxRuntime.jsxs(Theme.Page.Main, {
            children: [
                ...
                /*#__PURE__*/ jsxRuntime.jsx(formik.Formik, {
                    ...
                    children: ({ errors, handleChange, isSubmitting, values, setFieldValue })=>{
                        ...
                        return /*#__PURE__*/ jsxRuntime.jsxs(formik.Form, {
                            children: [
                                /*#__PURE__*/ jsxRuntime.jsx(TokenTypeSelect.FormHead, {
                                    title: {
                                ...
                                /*#__PURE__*/ jsxRuntime.jsx(index.Layouts.Content, {
                                    children: /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
                                        ...
                                        gap: 6,
                                        children: [
                                            Boolean(apiToken?.name) && /*#__PURE__*/ jsxRuntime.jsx(TokenTypeSelect.TokenBox, {
                                                token: apiToken?.accessKey,
                                                tokenType: constants.API_TOKEN_TYPE
                                            }),
                                            /*#__PURE__*/ jsxRuntime.jsx(FormApiTokenContainer, {
                                                errors: errors,
...
const ProtectedEditView = ()=>{
    const permissions = Theme.useTypedSelector((state)=>state.admin_app.permissions.settings?.['api-tokens'].read);
...
//# sourceMappingURL=EditViewPage-Bz4GEIsc.js.map
