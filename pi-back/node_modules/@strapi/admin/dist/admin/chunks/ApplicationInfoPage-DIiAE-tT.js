 ...
 * -----------------------------------------------------------------------------------------------*/ const ApplicationInfoPage = ()=>{
    ...
    const latestStrapiReleaseTag = Theme.useAppInfo('ApplicationInfoPage', (state)=>state.latestStrapiReleaseTag);
    ...
    const AdminSeatInfo = useEnterprise.useEnterprise(AdminSeatInfoCE, async ()=>(await Promise.resolve().then(function () { return require('./AdminSeatInfo-BfPqdNN0.js'); })).AdminSeatInfoEE);
    const { allowedActions: { canRead, canUpdate } } = Theme.useRBAC(settings ? settings['project-settings'] : {});
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs(index.Layouts.Root, {
        children: [
            ...
            /*#__PURE__*/ jsxRuntime.jsx(Theme.Page.Main, {
                                            ...
                                            /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Grid.Root, {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ jsxRuntime.jsx(designSystem.Grid.Item, {
                                                        ...
                                                        direction: "column",
                                                        alignItems: "stretch",
                                                        children: /*#__PURE__*/ jsxRuntime.jsx(LogoInput, {
                                                            canUpdate: canUpdate,
...
//# sourceMappingURL=ApplicationInfoPage-DIiAE-tT.js.map
