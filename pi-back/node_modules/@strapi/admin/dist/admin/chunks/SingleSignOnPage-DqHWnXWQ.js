...
const SingleSignOnPage = ()=>{
    ...
    const { isLoading: isLoadingPermissions, allowedActions: { canUpdate, canRead: canReadRoles } } = Theme.useRBAC({
                    ...
                    children: ({ modified, isSubmitting })=>/*#__PURE__*/ jsxRuntime.jsxs(jsxRuntime.Fragment, {
                            children: [
                                ...
                                /*#__PURE__*/ jsxRuntime.jsx(index.Layouts.Content, {
                                    children: isSubmitting || isLoadingData ? /*#__PURE__*/ jsxRuntime.jsx(Theme.Page.Loading, {}) : /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
                                        direction: "column",
                                        alignItems: "stretch",
                                        gap: 4,
                                        background: "neutral0",
...
const FormInputRenderer = (props)=>{
    switch(props.type){
        ...
        default:
            return /*#__PURE__*/ jsxRuntime.jsx(index.MemoizedInputRenderer, {
                ...props
            });
    }
};
...
//# sourceMappingURL=SingleSignOnPage-DqHWnXWQ.js.map
