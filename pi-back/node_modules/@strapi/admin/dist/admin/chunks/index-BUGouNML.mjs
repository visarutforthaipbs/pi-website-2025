...
import { useEffect, Suspense, useCallback, useMemo, useState, memo, forwardRef } from 'react';
...
import { z as createContext, S as StrapiAppProvider, A as AuthProvider, L as LanguageProvider, T as Theme, N as NotificationsProvider, B as TrackingProvider, G as GuidedTourProvider, D as ConfigurationProvider, E as LANGUAGE_LOCAL_STORAGE_KEY, P as Page, F as getIn, H as setIn, w as useConfiguration, b as useTypedSelector, d as useTypedDispatch, I as setLocale, u as useAuth, e as useAPIErrorHandler, J as useForgotPasswordMutation, a as useNotification, p as useAppInfo, c as useTracking, m as useGuidedTour, K as useGetRegistrationInfoQuery, M as useRegisterAdminMutation, O as useRegisterUserMutation, o as login, Q as useResetPasswordMutation, t as reducer$2, U as logout, V as THEME_LOCAL_STORAGE_KEY, r as getStoredToken, R as RBAC, n as useQueryParams, W as useTypedStore } from './Theme-CDaBfQ-7.mjs';
...
import { u as useEnterprise } from './useEnterprise-Dy8wMNV5.mjs';
import { i as isBaseQueryError, e as useInitQuery, a as adminApi, j as createAbsoluteUrl, k as getFetchClient } from './admin-BBS7sDVu.mjs';
 ...
 */ const getEERoutes$1 = ()=>window.strapi.isEE ? [
        {
            ...
            lazy: async ()=>{
                const { AuthResponse } = await import('./AuthResponse-DFS6gVO4.mjs');
                return {
        ...
        ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
            {
                path: 'audit-logs',
                lazy: async ()=>{
                    const { ProtectedListPage } = await import('./ListPage-Beh8uBDE.mjs');
                    return {
        ...
        ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
            {
                path: 'single-sign-on',
                lazy: async ()=>{
                    const { ProtectedSSO } = await import('./SingleSignOnPage-Bqn13t3u.mjs');
                    return {
 ...
 */ const useFocusInputField = (name)=>{
    ...
    const search = useMemo(()=>new URLSearchParams(searchString), [
        searchString
    ]);
    /**
...
const NpsSurvey = ()=>{
    ...
    return /*#__PURE__*/ jsx(Portal, {
        children: /*#__PURE__*/ jsx(Formik, {
            ...
            children: ({ values, handleChange, setFieldValue, isSubmitting })=>/*#__PURE__*/ jsx(Form$1, {
                    name: "npsSurveyForm",
                    children: /*#__PURE__*/ jsx(Flex, {
                        hasRadius: true,
                        direction: "column",
 ...
 * -----------------------------------------------------------------------------------------------*/ const AuthPage = ()=>{
    ...
    const { hasAdmin } = data ?? {};
    const Login$1 = useEnterprise(Login, async ()=>(await import('./Login-5ByBaKI3.mjs')).LoginEE);
    const forms = useEnterprise(FORMS, async ()=>(await import('./constants-DoArvzRr.mjs')).FORMS, {
...
const ROUTES_CE = [
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await import('./ListPage-Czwak48Z.mjs');
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreatePage } = await import('./CreatePage-0PdN9Fyc.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await import('./EditPage-BazkPM17.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await import('./ListPage-BtMdu1eQ.mjs');
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await import('./EditPage-LRn1-C88.mjs');
            return {
                Component: ProtectedEditPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreatePage } = await import('./CreatePage-DojcQqvH.mjs');
            return {
                Component: ProtectedCreatePage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await import('./EditPage-BNZ90ISm.mjs').then(function (n) { return n.b; });
            return {
                Component: ProtectedEditPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await import('./ListPage-CENQarKY.mjs');
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListView } = await import('./ListView-Q2AO0JSX.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await import('./CreateView-DB0xD4f5.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await import('./EditViewPage-BE_u8pQP.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await import('./CreateView-BuN2a7bo.mjs');
            return {
                Component: ProtectedCreateView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListView } = await import('./ListView-CajksON_.mjs');
            return {
                Component: ProtectedListView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await import('./EditView-CgMgqsza.mjs');
            return {
                Component: ProtectedEditView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedInstalledPlugins } = await import('./InstalledPlugins-B4gyKUHh.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseAuditLogs } = await import('./PurchaseAuditLogs-McvZESGI.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseSingleSignOn } = await import('./PurchaseSingleSignOn-BUB9Irlt.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseContentHistory } = await import('./PurchaseContentHistory-pb7RDvhZ.mjs');
            return {
 ...
 */ const getImmutableRoutes = ()=>[
        {
            path: 'usecase',
            lazy: async ()=>{
                const { PrivateUseCasePage } = await import('./UseCasePage-Y_h0Fbiv.mjs');
                return {
...
const getInitialRoutes = ()=>[
        {
            index: true,
            lazy: async ()=>{
                const { HomePage } = await import('./HomePage-CFTx_SgI.mjs');
                return {
                    Component: HomePage
                };
            }
        },
        {
            path: 'me',
            lazy: async ()=>{
                const { ProfilePage } = await import('./ProfilePage-Do6nPMsx.mjs');
                return {
        ...
        },
        {
            path: 'marketplace',
            lazy: async ()=>{
                const { ProtectedMarketplacePage } = await import('./MarketplacePage-BrHNQ8SG.mjs');
                return {
        ...
        },
        {
            path: 'settings/*',
            lazy: async ()=>{
                const { Layout } = await import('./Layout-B_xkPr1q.mjs');
                return {
                    Component: Layout
                };
            },
            children: [
                {
                    ...
                    lazy: async ()=>{
                        const { ApplicationInfoPage } = await import('./ApplicationInfoPage-Ch6hKH4Y.mjs');
                        return {
...
class Router {
   ...
   */ createRouter(strapi, { memory, ...opts } = {}) {
        const routes = [
            {
                path: '/*',
                errorElement: /*#__PURE__*/ jsx(Provider$1, {
                    store: strapi.store,
                    children: /*#__PURE__*/ jsx(LanguageProvider, {
                        messages: strapi.configurations.translations,
                        children: /*#__PURE__*/ jsx(Theme, {
                ...
                children: [
                    ...getImmutableRoutes(),
                    {
                        path: '/*',
                        lazy: async ()=>{
                            const { PrivateAdminLayout } = await import('./AuthenticatedLayout-BNWCtSH2.mjs');
                            return {
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case './translations/ar.json': return import('./ar-DIoaNhYi.mjs');
    case './translations/ca.json': return import('./ca-CiTVrP0z.mjs');
    case './translations/cs.json': return import('./cs-D7xysdyX.mjs');
    case './translations/de.json': return import('./de-BWQ7SIyM.mjs');
    case './translations/dk.json': return import('./dk-7AZJZW29.mjs');
    case './translations/en.json': return import('./en-CRu3-kTC.mjs');
    case './translations/es.json': return import('./es-DlUN520X.mjs');
    case './translations/eu.json': return import('./eu-BjPzWjP-.mjs');
    case './translations/fr.json': return import('./fr-D-lfObnF.mjs');
    case './translations/gu.json': return import('./gu-DMqR9PzV.mjs');
    case './translations/he.json': return import('./he-DfIYPy4g.mjs');
    case './translations/hi.json': return import('./hi-C1bRwQm3.mjs');
    case './translations/hu.json': return import('./hu-DTUInqNe.mjs');
    case './translations/id.json': return import('./id-CLj6OS01.mjs');
    case './translations/it.json': return import('./it-CI4iXN-s.mjs');
    case './translations/ja.json': return import('./ja-XD0qdvmh.mjs');
    case './translations/ko.json': return import('./ko-CAChQtgZ.mjs');
    case './translations/ml.json': return import('./ml-OZdE-Rdf.mjs');
    case './translations/ms.json': return import('./ms-CWDO45lu.mjs');
    case './translations/nl.json': return import('./nl-BRq2PB1q.mjs');
    case './translations/no.json': return import('./no-BtzfHZUH.mjs');
    case './translations/pl.json': return import('./pl-BsvtDLRo.mjs');
    case './translations/pt-BR.json': return import('./pt-BR-DBqHmqA5.mjs');
    case './translations/pt.json': return import('./pt-wKaSOdHh.mjs');
    case './translations/ru.json': return import('./ru-C13N1yaO.mjs');
    case './translations/sa.json': return import('./sa-BS5xpa-V.mjs');
    case './translations/sk.json': return import('./sk-Yv9s7dUn.mjs');
    case './translations/sv.json': return import('./sv-CaQpgtnl.mjs');
    case './translations/th.json': return import('./th-Mav5tUMF.mjs');
    case './translations/tr.json': return import('./tr-DZnC0Jye.mjs');
    case './translations/uk.json': return import('./uk-Cb6a0PAZ.mjs');
    case './translations/vi.json': return import('./vi-r6WrFGyI.mjs');
    case './translations/zh-Hans.json': return import('./zh-Hans-BmHHqjob.mjs');
    case './translations/zh.json': return import('./zh-CIjQrG_x.mjs');
...
function __variableDynamicImportRuntime0__(path) {
  switch (path) {
    case './translations/en-GB.js': return import('./en-GB-DZyWkup_.mjs');
    default: return new Promise(function(resolve, reject) {
      (typeof queueMicrotask === 'function' ? queueMicrotask : setTimeout)(
        reject.bind(null, new Error("Unknown variable dynamic import: " + path))
      );
 ...
 * }
 * ```
 */ const ConfirmDialog = ({ children, icon = /*#__PURE__*/ jsx(StyledWarning, {}), onConfirm, variant = 'danger-light', startAction, endAction, title })=>{
    const { formatMessage } = useIntl();
 ...
 * };
 * ```
 */ const Root$1 = /*#__PURE__*/ React.forwardRef(({ children, defaultPageSize = 10, pageCount = 0, defaultPage = 1, onPageSizeChange, total = 0 }, forwardedRef)=>{
    const [{ query }, setQuery] = useQueryParams({
