 ...
 */ const getEERoutes$1 = ()=>window.strapi.isEE ? [
        {
            ...
            lazy: async ()=>{
                const { AuthResponse } = await Promise.resolve().then(function () { return require('./AuthResponse-DI-Q1kQL.js'); });
                return {
        ...
        ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
            {
                path: 'audit-logs',
                lazy: async ()=>{
                    const { ProtectedListPage } = await Promise.resolve().then(function () { return require('./ListPage-DgmOJv7H.js'); });
                    return {
        ...
        ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
            {
                path: 'single-sign-on',
                lazy: async ()=>{
                    const { ProtectedSSO } = await Promise.resolve().then(function () { return require('./SingleSignOnPage-DqHWnXWQ.js'); });
                    return {
 ...
 * -----------------------------------------------------------------------------------------------*/ const AuthPage = ()=>{
    ...
    const { hasAdmin } = data ?? {};
    const Login$1 = useEnterprise.useEnterprise(Login, async ()=>(await Promise.resolve().then(function () { return require('./Login-BpEOnVbU.js'); })).LoginEE);
    const forms = useEnterprise.useEnterprise(FORMS, async ()=>(await Promise.resolve().then(function () { return require('./constants-DClZ3JYF.js'); })).FORMS, {
...
const ROUTES_CE = [
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await Promise.resolve().then(function () { return require('./ListPage-gKsEm3Px.js'); });
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreatePage } = await Promise.resolve().then(function () { return require('./CreatePage-BK_ivKDk.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await Promise.resolve().then(function () { return require('./EditPage-r043NYgB.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await Promise.resolve().then(function () { return require('./ListPage-Du6Jt5wY.js'); });
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await Promise.resolve().then(function () { return require('./EditPage-ibh8EtSv.js'); });
            return {
                Component: ProtectedEditPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreatePage } = await Promise.resolve().then(function () { return require('./CreatePage-C8PMNi_P.js'); });
            return {
                Component: ProtectedCreatePage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditPage } = await Promise.resolve().then(function () { return require('./EditPage-DiDSR0tz.js'); }).then(function (n) { return n.EditPage$1; });
            return {
                Component: ProtectedEditPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListPage } = await Promise.resolve().then(function () { return require('./ListPage-LqcmQd_Q.js'); });
            return {
                Component: ProtectedListPage
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListView } = await Promise.resolve().then(function () { return require('./ListView-BfwBUxHL.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await Promise.resolve().then(function () { return require('./CreateView-ITRNGoQ6.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await Promise.resolve().then(function () { return require('./EditViewPage-Bz4GEIsc.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await Promise.resolve().then(function () { return require('./CreateView-DtccbWiR.js'); });
            return {
                Component: ProtectedCreateView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedListView } = await Promise.resolve().then(function () { return require('./ListView-Bys8EN-y.js'); });
            return {
                Component: ProtectedListView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await Promise.resolve().then(function () { return require('./EditView-DxmJI6e0.js'); });
            return {
                Component: ProtectedEditView
            };
        },
    ...
    {
        lazy: async ()=>{
            const { ProtectedInstalledPlugins } = await Promise.resolve().then(function () { return require('./InstalledPlugins-BtwwVsQ_.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseAuditLogs } = await Promise.resolve().then(function () { return require('./PurchaseAuditLogs-BTAi887h.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseSingleSignOn } = await Promise.resolve().then(function () { return require('./PurchaseSingleSignOn-Dgal5RnY.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { PurchaseContentHistory } = await Promise.resolve().then(function () { return require('./PurchaseContentHistory-dfepsahq.js'); });
            return {
 ...
 */ const getImmutableRoutes = ()=>[
        {
            path: 'usecase',
            lazy: async ()=>{
                const { PrivateUseCasePage } = await Promise.resolve().then(function () { return require('./UseCasePage-Dl-WfgYc.js'); });
                return {
...
const getInitialRoutes = ()=>[
        {
            index: true,
            lazy: async ()=>{
                const { HomePage } = await Promise.resolve().then(function () { return require('./HomePage-Df0YSqNE.js'); });
                return {
                    Component: HomePage
                };
            }
        },
        {
            path: 'me',
            lazy: async ()=>{
                const { ProfilePage } = await Promise.resolve().then(function () { return require('./ProfilePage-C8zWtYzY.js'); });
                return {
        ...
        },
        {
            path: 'marketplace',
            lazy: async ()=>{
                const { ProtectedMarketplacePage } = await Promise.resolve().then(function () { return require('./MarketplacePage-my1nDaHy.js'); });
                return {
        ...
        },
        {
            path: 'settings/*',
            lazy: async ()=>{
                const { Layout } = await Promise.resolve().then(function () { return require('./Layout-BZTqa7oj.js'); });
                return {
                    Component: Layout
                };
            },
            children: [
                {
                    ...
                    lazy: async ()=>{
                        const { ApplicationInfoPage } = await Promise.resolve().then(function () { return require('./ApplicationInfoPage-DIiAE-tT.js'); });
                        return {
        ...
        const routes = [
            {
                ...
                children: [
                    ...getImmutableRoutes(),
                    {
                        path: '/*',
                        lazy: async ()=>{
                            const { PrivateAdminLayout } = await Promise.resolve().then(function () { return require('./AuthenticatedLayout-D067wUoO.js'); });
                            return {
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    ...
    case './translations/en.json': return Promise.resolve().then(function () { return require('./en-CJjqxA2Q.js'); });
    ...
    case './translations/uk.json': return Promise.resolve().then(function () { return require('./uk-gz16FlMw.js'); });
...
function __variableDynamicImportRuntime0__(path) {
  switch (path) {
    case './translations/en-GB.js': return Promise.resolve().then(function () { return require('./en-GB-CMP_CCZs.js'); });
    default: return new Promise(function(resolve, reject) {
      (typeof queueMicrotask === 'function' ? queueMicrotask : setTimeout)(
        reject.bind(null, new Error("Unknown variable dynamic import: " + path))
      );
...
//# sourceMappingURL=index-D7OmC33R.js.map
