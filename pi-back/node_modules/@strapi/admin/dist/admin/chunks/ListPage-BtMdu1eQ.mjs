...
import { e as errorsTrads, q as useCreateUserMutation, F as Form, M as MemoizedInputRenderer, k as useAdminUsers, r as useDeleteManyUsersMutation, b as Layouts, S as SearchInput, s as Filters, T as Table, P as Pagination, C as ConfirmDialog } from './index-BUGouNML.mjs';
import { a as useNotification, e as useAPIErrorHandler, b as useTypedSelector, P as Page, k as useRBAC } from './Theme-CDaBfQ-7.mjs';
import { u as useEnterprise } from './useEnterprise-Dy8wMNV5.mjs';
import { g as getDisplayName } from './users-B3iOAYG-.mjs';
import * as yup from 'yup';
import { i as isBaseQueryError } from './admin-BBS7sDVu.mjs';
import { M as MagicLinkCE, S as SelectRoles } from './SelectRoles-CG3Czm0u.mjs';
...
import './useAdminRoles-BEmkB0uj.mjs';
...
const ModalForm = ({ onToggle })=>{
    ...
    const roleLayout = useEnterprise(ROLE_LAYOUT, async ()=>(await import('./ModalForm-CZ98aSC9.mjs')).ROLE_LAYOUT, {
    ...
    const initialValues = useEnterprise(FORM_INITIAL_VALUES, async ()=>(await import('./ModalForm-CZ98aSC9.mjs')).FORM_INITIAL_VALUES, {
    ...
    const MagicLink = useEnterprise(MagicLinkCE, async ()=>(await import('./MagicLinkEE-CiQG7NL3.mjs')).MagicLinkEE);
 ...
 * -----------------------------------------------------------------------------------------------*/ const ListPageCE = ()=>{
    ...
    const CreateAction = useEnterprise(CreateActionCE, async ()=>(await import('./CreateActionEE-DZ6ApqOF.mjs')).CreateActionEE);
...
const ListPage = ()=>{
    const UsersListPage = useEnterprise(ListPageCE, async ()=>// eslint-disable-next-line import/no-cycle
        (await import('./ListPage-r9rW__R8.mjs')).UserListPageEE);
    // block rendering until the EE component is fully loaded
    if (!UsersListPage) {
        return null;
    }
...
//# sourceMappingURL=ListPage-BtMdu1eQ.mjs.map
