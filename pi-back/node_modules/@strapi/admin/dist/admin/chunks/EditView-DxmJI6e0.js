 ...
 * -----------------------------------------------------------------------------------------------*/ const EditView = ()=>{
    ...
    const permissions = Theme.useTypedSelector((state)=>state.admin_app.permissions.settings?.['transfer-tokens']);
    const { allowedActions: { canCreate, canUpdate, canRegenerate } } = Theme.useRBAC(permissions);
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ jsxRuntime.jsx(index.Layouts.Content, {
                                children: /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
                                    ...
                                    gap: 6,
                                    children: [
                                        transferToken && Boolean(transferToken?.name) && 'accessKey' in transferToken && /*#__PURE__*/ jsxRuntime.jsx(TokenTypeSelect.TokenBox, {
 ...
 * -----------------------------------------------------------------------------------------------*/ const ProtectedEditView = ()=>{
    const permissions = Theme.useTypedSelector((state)=>state.admin_app.permissions.settings?.['transfer-tokens'].read);
...
//# sourceMappingURL=EditView-DxmJI6e0.js.map
