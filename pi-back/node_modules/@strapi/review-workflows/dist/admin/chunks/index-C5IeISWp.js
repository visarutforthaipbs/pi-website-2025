...
const REVIEW_WORKFLOW_COLUMNS = [
    {
        ...
        cellFormatter: (props)=>/*#__PURE__*/ jsxRuntime.jsx(StageColumn, {
                ...props
            })
    },
    {
        ...
        cellFormatter: (props)=>/*#__PURE__*/ jsxRuntime.jsx(AssigneeColumn, {
                ...props
            })
    }
];
...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    case './translations/en.json': return Promise.resolve().then(function () { return require('./en-C6SESe-Y.js'); });
    ...
    register (app) {
        if (window.strapi.features.isEnabled(FEATURE_ID)) {
            ...
            app.addSettingsLink('global', {
                ...
                permissions: [],
                async Component () {
                    const { PurchaseReviewWorkflows } = await Promise.resolve().then(function () { return require('./purchase-review-workflows-Drlxm8yP.js'); });
                    return {
