...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    case './translations/en.json': return import('./en-BixG7IBu.mjs');
    ...
    register (app) {
        if (window.strapi.features.isEnabled(FEATURE_ID)) {
            ...
            app.addSettingsLink('global', {
                ...
                permissions: [],
                async Component () {
                    const { Router } = await import('./router-Z3AR7XZ7.mjs');
                    return {
                        default: Router
                    };
                }
            ...
            app.addSettingsLink('global', {
                ...
                permissions: [],
                async Component () {
                    const { PurchaseReviewWorkflows } = await import('./purchase-review-workflows-CEP8kvxZ.mjs');
                    return {
...
export { AVAILABLE_COLORS as A, CHARGEBEE_WORKFLOW_ENTITLEMENT_NAME as C, LimitsModal as L, useTypedSelector as a, CHARGEBEE_STAGES_PER_WORKFLOW_ENTITLEMENT_NAME as b, useGetWorkflowsQuery as c, useCreateWorkflowMutation as d, useUpdateWorkflowMutation as e, useDeleteWorkflowMutation as f, getStageColorByHex as g, admin as h, isBaseQueryError as i, reviewWorkflowsApi as r, useGetContentTypesQuery as u };
//# sourceMappingURL=index-CSYOmjZt.mjs.map
