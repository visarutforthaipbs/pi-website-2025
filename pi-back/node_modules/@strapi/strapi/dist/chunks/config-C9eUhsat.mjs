...
import { l as loadStrapiMonorepo, g as getMonorepoAliases, a as getUserConfig } from './aliases-ovUFcarU.mjs';
...
const resolveBaseConfig = async (ctx)=>{
    ...
    return {
        ...
        plugins: [
            ...
            new DefinePlugin(Object.entries(ctx.env).reduce((acc, [key, value])=>{
...
//# sourceMappingURL=config-C9eUhsat.mjs.map
