...
// node_modules/@strapi/admin/dist/admin/chunks/EditPage-BNZ90ISm.mjs
...
var Status = ({ isPending, statusCode }) => {
  ...
  if (isPending || !statusCode) {
    return (0, import_jsx_runtime.jsxs)(Flex, {
      ...
      alignItems: "center",
      children: [
        (0, import_jsx_runtime.jsx)(ForwardRef$2f, {
          height: "1.2rem",
          width: "1.2rem"
        }),
        (0, import_jsx_runtime.jsx)(Typography, {
...
var WebhookForm = ({ handleSubmit, triggerWebhook, isCreating, isTriggering, triggerResponse, data }) => {
  ...
  const EventTable = useEnterprise(EventTableCE, async () => (await import("./EventsTable-CsFf4rOj-WFYWH7FP.js")).EventsTableEE);
...
//# sourceMappingURL=chunk-DF3XNKQK.js.map
