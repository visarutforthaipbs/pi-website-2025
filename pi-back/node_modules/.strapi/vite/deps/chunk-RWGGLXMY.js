...
var getEERoutes$1 = () => window.strapi.isEE ? [
  {
    ...
    lazy: async () => {
      const { AuthResponse } = await import("./AuthResponse-DFS6gVO4-H6FPXUPL.js");
      return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-Beh8uBDE-H7STIQSC.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-Bqn13t3u-5UOC5UFV.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-5ByBaKI3-P2RJXSYN.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-DoArvzRr-UIPBHPYT.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-Czwak48Z-PEAXYYUU.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-0PdN9Fyc-ODSZDIL3.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-BazkPM17-4ID4UTNI.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-BtMdu1eQ-6F4WPUEJ.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-LRn1-C88-AUDLQMPI.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-DojcQqvH-FIRDHU7N.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-BNZ90ISm-53R4THOD.js").then(function(n) {
        return n.b;
      });
      return {
        Component: ProtectedEditPage
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-CENQarKY-Z3BRDRFW.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-Q2AO0JSX-QXQVC2WQ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-DB0xD4f5-ZAX6QS2D.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-BE_u8pQP-FK4ULGOU.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-BuN2a7bo-FFMAH7F4.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-CajksON_-VZBJLIF3.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-CgMgqsza-IN7DVE2A.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-B4gyKUHh-YCUR4HYT.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-McvZESGI-3DPTYSRL.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-BUB9Irlt-NVCULIGJ.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-pb7RDvhZ-7EBCXNFV.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-Y_h0Fbiv-QVVX62ZB.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-CFTx_SgI-6XFBUUOG.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-Do6nPMsx-5EQODGOD.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-BrHNQ8SG-BSRS4XHK.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-B_xkPr1q-CDMB3UZU.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-Ch6hKH4Y-XQQZBNGB.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-BNWCtSH2-GFZXMX4K.js");
              return {
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "./translations/ar.json":
      return import("./ar-DIoaNhYi-VLVTUSMA.js");
    case "./translations/ca.json":
      return import("./ca-CiTVrP0z-KNNE2MD4.js");
    case "./translations/cs.json":
      return import("./cs-D7xysdyX-AQCVP6XT.js");
    case "./translations/de.json":
      return import("./de-BWQ7SIyM-Q5J4MB6M.js");
    case "./translations/dk.json":
      return import("./dk-7AZJZW29-RKCC62EW.js");
    case "./translations/en.json":
      return import("./en-CRu3-kTC-RPCTIX4L.js");
    case "./translations/es.json":
      return import("./es-DlUN520X-2DD7NEU3.js");
    case "./translations/eu.json":
      return import("./eu-BjPzWjP--IF4MOKIB.js");
    case "./translations/fr.json":
      return import("./fr-D-lfObnF-72ES6C2X.js");
    case "./translations/gu.json":
      return import("./gu-DMqR9PzV-NGPGHBDT.js");
    case "./translations/he.json":
      return import("./he-DfIYPy4g-I53A63IK.js");
    case "./translations/hi.json":
      return import("./hi-C1bRwQm3-LXZ5MIFC.js");
    case "./translations/hu.json":
      return import("./hu-DTUInqNe-HSJITQOU.js");
    case "./translations/id.json":
      return import("./id-CLj6OS01-EWSTWAR3.js");
    case "./translations/it.json":
      return import("./it-CI4iXN-s-FAHSFSRC.js");
    case "./translations/ja.json":
      return import("./ja-XD0qdvmh-BMAWGSI5.js");
    case "./translations/ko.json":
      return import("./ko-CAChQtgZ-MJX5ZKZO.js");
    case "./translations/ml.json":
      return import("./ml-OZdE-Rdf-AAHYTSMB.js");
    case "./translations/ms.json":
      return import("./ms-CWDO45lu-KGYDROON.js");
    case "./translations/nl.json":
      return import("./nl-BRq2PB1q-3NL77IET.js");
    case "./translations/no.json":
      return import("./no-BtzfHZUH-U452HBQU.js");
    case "./translations/pl.json":
      return import("./pl-BsvtDLRo-KWEH7OUW.js");
    case "./translations/pt-BR.json":
      return import("./pt-BR-DBqHmqA5-6P3ANH2S.js");
    case "./translations/pt.json":
      return import("./pt-wKaSOdHh-WTRSJIGK.js");
    case "./translations/ru.json":
      return import("./ru-C13N1yaO-IWRRDRXX.js");
    case "./translations/sa.json":
      return import("./sa-BS5xpa-V-3EGMEIHA.js");
    case "./translations/sk.json":
      return import("./sk-Yv9s7dUn-W2TM27CH.js");
    case "./translations/sv.json":
      return import("./sv-CaQpgtnl-6FLUFP6V.js");
    case "./translations/th.json":
      return import("./th-Mav5tUMF-Q2XI2OGA.js");
    case "./translations/tr.json":
      return import("./tr-DZnC0Jye-5GCU4ZMJ.js");
    case "./translations/uk.json":
      return import("./uk-Cb6a0PAZ-LPZCA2AK.js");
    case "./translations/vi.json":
      return import("./vi-r6WrFGyI-GB3ABNBH.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans-BmHHqjob-KHKL55RZ.js");
    case "./translations/zh.json":
      return import("./zh-CIjQrG_x-N6WMXVM7.js");
    default:
      return new Promise(function(resolve, reject) {
...
function __variableDynamicImportRuntime0__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-DZyWkup_-M4IIDPVI.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
...
//# sourceMappingURL=chunk-RWGGLXMY.js.map
