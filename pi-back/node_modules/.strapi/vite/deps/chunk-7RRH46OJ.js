...
// node_modules/@strapi/review-workflows/dist/admin/chunks/index-CSYOmjZt.mjs
...
var AssigneeSelect = () => {
  ...
  const { data, isLoading, isError } = useAdminUsers(void 0, {
      ...
      (0, import_jsx_runtime.jsxs)(Field.Root, {
        ...
        children: [
          ...
          (0, import_jsx_runtime.jsx)(SingleSelect, {
            ...
            children: stages.map(({ id: id2, color, name }) => {
...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en-BixG7IBu-QZ57UOGG.js");
    default:
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-Z3AR7XZ7-CVL4XVDA.js");
          return {
            default: Router
          };
        }
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-CEP8kvxZ-5AVSGC5C.js");
          return {
...
//# sourceMappingURL=chunk-7RRH46OJ.js.map
