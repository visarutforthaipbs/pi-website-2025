...
// node_modules/@strapi/admin/dist/admin/chunks/ListPage-BtMdu1eQ.mjs
...
var ModalForm = ({ onToggle }) => {
  ...
  const roleLayout = useEnterprise(ROLE_LAYOUT, async () => (await import("./ModalForm-CZ98aSC9-O6AHAX3E.js")).ROLE_LAYOUT, {
  ...
  const initialValues = useEnterprise(FORM_INITIAL_VALUES, async () => (await import("./ModalForm-CZ98aSC9-O6AHAX3E.js")).FORM_INITIAL_VALUES, {
  ...
  const MagicLink = useEnterprise(MagicLinkCE, async () => (await import("./MagicLinkEE-CiQG7NL3-4G4RIIIX.js")).MagicLinkEE);
...
var ListPageCE = () => {
  ...
  const CreateAction = useEnterprise(CreateActionCE, async () => (await import("./CreateActionEE-DZ6ApqOF-7AMQFZLK.js")).CreateActionEE);
...
var ListPage = () => {
  const UsersListPage = useEnterprise(ListPageCE, async () => (
    ...
    (await import("./ListPage-r9rW__R8-ROVW74ZA.js")).UserListPageEE
  ));
  if (!UsersListPage) {
    return null;
  }
...
//# sourceMappingURL=chunk-CHORB4ZY.js.map
