...
// node_modules/@strapi/upload/dist/admin/chunks/zh-BIl0qgBy.mjs
var zh = {
  "apiError.FileTooBig": "上傳的檔案超出允許的最大素材大小。",
  "upload.generic-error": "上傳檔案時發生錯誤。",
  "bulk.select.label": "選取所有素材",
  "button.next": "繼續",
  "checkControl.crop-duplicate": "複製及裁切素材",
  "checkControl.crop-original": "裁切原始素材",
  "content.isLoading": "正在載入內容。",
  "control-card.add": "增加",
  ...
  "header.actions.add-folder": "新增資料夾",
  "header.actions.add-assets.folder": "資料夾",
  "header.actions.upload-assets": "上傳素材",
  "header.actions.upload-new-asset": "上傳新素材",
  ...
  "input.placeholder.icon": "將素材拖曳至此區域",
  "input.url.description": "以跳行符號分隔連結",
  "input.url.label": "連結",
  "list.assets.title": "素材",
  "list.asset.at.finished": "素材已完成載入。",
  "list.assets-empty.search": "找不到結果",
  "list.assets-empty.subtitle": "從開頭新增",
  "list.assets-empty.title": "尚無任何素材",
  "list.assets-empty.title-withSearch": "無素材符合此過濾條件",
  "list.assets.empty": "媒體庫為空",
  "list.assets.empty-upload": "上傳您的首個素材...",
  "list.assets.empty.no-permissions": "無檢視權限",
  ...
  "mediaLibraryInput.placeholder": "點擊以新增素材，或拖曳至此區域",
  "mediaLibraryInput.slideCount": "投影片 {n} 之 {m}",
  "modal.file-details.date": "日期",
  "modal.file-details.dimensions": "尺寸",
  "modal.file-details.extension": "副檔名",
  "modal.file-details.size": "大小",
  "modal.file-details.id": "素材 ID",
  "modal.folder.elements.count": "{folderCount} 資料夾，{assetCount} 素材",
  ...
  "page.title": "設定 - 媒體庫",
  "permissions.not-allowed.update": "您不被允許編輯此檔案。",
  "plugin.description.long": "媒體檔案管理",
  "plugin.description.short": "媒體檔案管理",
  "plugin.name": "媒體庫",
  "search.clear.label": "清除搜尋",
  "search.label": "搜尋素材",
  "search.placeholder": "搜尋素材",
  "settings.blockTitle": "素材管理",
  ...
  "settings.form.sizeOptimization.description": "啟用此選向將縮減圖片大小，並稍微降低品質。",
...
//# sourceMappingURL=zh-BIl0qgBy-43LEBNOM.js.map
