...
// node_modules/@strapi/content-releases/dist/admin/chunks/index-CmAFGQWf.mjs
...
var ReleaseActionModalForm = ({ documentId, document, model, collectionType }) => {
  ...
  return {
    ...
    icon: (0, import_jsx_runtime.jsx)(ForwardRef$1x, {}),
    ...
    children: [
      (0, import_jsx_runtime.jsx)(Popover.Trigger, {
        children: (0, import_jsx_runtime.jsx)(Button, {
          ...
          endIcon: releases.length > 0 ? (0, import_jsx_runtime.jsx)(ForwardRef$4N, {
            width: "1.2rem",
            height: "1.2rem"
          }) : null,
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en-B2EeDoOz-4IKOXYZS.js");
    default:
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-CuOosufQ-ISQPJY66.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-BzdLEfxa-XRXXIL4Z.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-S1ccDSwp-56AH2PXF.js");
          return {
...
//# sourceMappingURL=chunk-KXHIUW7K.js.map
