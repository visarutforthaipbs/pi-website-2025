...
// node_modules/@strapi/admin/dist/admin/chunks/vi-r6WrFGyI.mjs
var Analytics = "Phân Tích";
var Documentation = "Tài liệu";
var Email = "Email";
var Password = "Mật Khẩu";
var Provider = "Nhà Cung Cấp";
var ResetPasswordToken = "Cài Lại Chuỗi Khóa Mật Khẩu";
var Role = "Vai trò";
var Username = "Tên đăng nhập";
...
var vi = {
  ...
  "Auth.form.error.code.provide": "Mã được cung cấp không chính xác.",
  "Auth.form.error.confirmed": "Tài khoản Email của bạn chưa được xác nhận.",
  ...
  "Auth.form.error.params.provide": "Tham số được cung cấp không chính xác.",
  ...
  "Auth.form.error.username.taken": "Tên đăng nhập đã tồn tại.",
  ...
  "app.components.HomePage.welcome": "Chào mừng bạn đã tham gia 👋",
  ...
  "app.components.ListPluginsPage.head.title": "Danh sách plugins",
  ...
  "components.Input.error.validation.json": "Đây không phải là định dạng JSON",
  "components.Input.error.validation.max": "Giá trị quá cao {max}.",
  "components.Input.error.validation.maxLength": "Giá trị quá dài {max}.",
  "components.Input.error.validation.min": "Giá trị quá thấp {min}.",
  "components.Input.error.validation.minLength": "Giá trị quá ngắn {min}.",
  ...
  "components.Wysiwyg.collapse": "Thu lại",
...
//# sourceMappingURL=vi-r6WrFGyI-GB3ABNBH.js.map
