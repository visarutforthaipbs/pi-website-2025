...
// node_modules/@strapi/upload/dist/admin/chunks/ru-CGgHRTey.mjs
var ru = {
  "button.next": "Далее",
  ...
  "modal.upload-list.sub-header-subtitle": "Управление ресурсами перед добавлением в медиа-библиотеку",
  "modal.upload-list.sub-header.button": "Добавить ещё ресурсы",
  "plugin.description.long": "Управление медиа-файлами.",
  "plugin.description.short": "Управление медиа-файлами.",
  "plugin.name": "Медиа-библиотека",
  ...
  "settings.header.label": "Медиа-библиотека - Настройки",
  "settings.section.image.label": "ИЗОБРАЖЕНИЕ",
  "settings.section.video.label": "ВИДЕО",
  "settings.sub-header.label": "Настройка медиа-библиотеки",
...
//# sourceMappingURL=ru-CGgHRTey-FKXYYFC2.js.map
